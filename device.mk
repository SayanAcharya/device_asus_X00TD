...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/init.qti.fm.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.qti.fm.rc \
    $(LOCAL_PATH)/configs/init.qti.fm.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.qti.fm.sh \
